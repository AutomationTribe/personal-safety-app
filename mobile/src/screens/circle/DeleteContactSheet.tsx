...
interface Props {
  ...
  onClose: () => void;
  onDeleted: (contact: TrustedContact) => void;
}

// Stub — full implementation is a separate task
const DeleteContactSheet = ({ visible, onClose }: Props) => (
  <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
    <View style={styles.overlay}>
      <View style={styles.sheet}>
        <Text style={styles.label}>Delete contact — coming soon</Text>
...
const styles = StyleSheet.create({
  ...
  btn: { height: 48, backgroundColor: '#C0392B', borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
